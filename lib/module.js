...
module.exports = function module (moduleOptions) {
  if (Array.isArray(this.options.sitemap)) {
    for (let i = 0; i < this.options.sitemap.length; i++) {
      const defaults = {
        path: this.options.sitemap[i].path || 'sitemap.xml',
      ...
      const options = Object.assign({}, defaults, this.options.sitemap[i], moduleOptions)
